...
ImageButton1.Image = "http://www.roblox.com/asset/?id=17094709022"
...
spawn(function()
    while wait(.1) do
		if game.Players.LocalPlayer.Character.Humanoid.Health <= 100 or game.Players.LocalPlayer.Character.Humanoid.Health <= 26 then
			SafeFrame = CFrame.new(0,PosY,0)
		elseif game.Players.LocalPlayer.Character.Humanoid.Health <= 25 then
			SafeFrame = CFrame.new(0,100,0)
        end
        end
    end)
    ...
    function AttackNoCD()
        if not _G.AutoFarmGunMastery and not _G.AutoFarmFruitMastery then
        ...
        if _G.AutoFarmGunMastery or _G.AutoFarmGunMastery then
...
local Main = Library:AddTab("Framing/Stack","10723407389")
local M = Library:AddTab("Item & Quest","13075622619")
local Ss = Library:AddTab("Stats Player","7040410130")
local RaceV4 = Library:AddTab("Race V4","11446900930")
local P = Library:AddTab("Local Player","7251993295")
local R = Library:AddTab("Tabs Raid","10709761722")
local T = Library:AddTab("Teleport","11155851001")
local S = Library:AddTab("Tabs Shop","6031265976")
local D = Library:AddTab("Tabs Fruit","14764233722")
local Misc = Library:AddTab("Miscellaneous","10709782582")
...
H:AddLine()
H:AddLabel("New Update Log")
H:AddLabel("[+] New Tween|19/3/2567/20:21")
...
H:AddLabel("[+] Auto Farm No Quest|2/1/2567|20:28")
H:AddLabel("[+] Auto Set Frame Mon (CheckMon)|9/1/2567|20:28")
H:AddLabel("[+] Esp Kisune|14/1/2567|08:08")
H:AddLabel("[+] Auto Get Fruit Inventory|20/2/2567|15:30")
H:AddLabel("[+] Fix Fast Attack|10/3/2567|12:15")
H:AddLabel("[+] New Tween|19/3/256720:21")
...
spawn(function()
    ...
    Main:AddToggle("Fast Attack Extreme ",_G.NotDeley,function(value)
        _G.NotDeley = value
    end)      
        ...
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                ...
                game.StarterGui:SetCore("SendNotification", {
					Title =  "Tri Minh Hub", 
					Text = "Full Moon" ,
					Icon = "http://www.roblox.com/asset/?id=17094709022",
					Duration = 2.5
				})
...
_G.SelectLocalTeleportSea = value
    ...
    M:AddToggle("Auto Farm Terrorshark(Safe Mode At Health 25%)", _G.AutoTerrorshark,function(value)
                            ...
                            if v.Name == "Terrorshark" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat wait(_G.Fast_Delay)
                                        ...
                                        PosNarathiwat = v.HumanoidRootPart.CFrame
                                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                        topos(v.HumanoidRootPart.CFrame * SafeFrame)
                                        Min_XT_Is_Kak = true
                                        AttackNoCD()
...
FrozenIsland = M:AddLabel("")
    ...
    M:AddToggle("Auto Collect Azuer Ember",_G.AutoAzuerEmber,function(value)
