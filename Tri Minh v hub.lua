...
ImageButton.Image = "http://www.roblox.com/asset/?id=17114612425"
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://17114612425"
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
            wait(2.0)
        elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=17114612425" then
            Hop()
            Fluent:Notify({
                Title = "Tri Minh  Hub",
...
warn("Tri Minh Hub Loading Completed !!")
