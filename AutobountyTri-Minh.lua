...
local Window = OrionLib:MakeWindow({Name = "Rimus Hub Auto Bounty", HidePremium = true, SaveConfig = true, ConfigFolder = "Rimus Hub Auto Bounty Config"})
--- Counter
local MainTab = Window:MakeTab({
	Name = "Main",
	Icon = "rbxassetid://16968165624",
	PremiumOnly = true
})
MainTab:AddButton({
	Name = "Next Player",
...
MainTab:AddButton({
	...
	Callback = function()
        setclipboard("https://discord.com/invite/6gZxCRsb")
  	end    
})
...
game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(child)
    if not hopserver and child.Name == 'ErrorPrompt' and child:FindFirstChild('MessageArea') and child.MessageArea:FindFirstChild("ErrorFrame") then
        ...
        Notify("Tri Minh Hub Auto Bounty | Rejoin from kicked!")
    end
end)
--- Webhook
function wSend(main)
...
function wTest() 
    local data = {
        ...
        ["embeds"] = {
            {
                ["title"] = "**Tri Minh Hub | Auto Bounty**",
                ["color"] = 0x58b9ff,
                ["fields"] = {
                    {
                        ["name"] = "Test Webhook",
                        ["value"] = "Tri Minh was here :eyes:",
                        ["inline"] = true,
                    },
                },
                ["thumbnail"] = {
            ...
            ["embeds"] = {
                {
                    ...
                    ["footer"] = {
                        ["text"] = "Tri Minh Hub - discord.gg/FZzxtjgjte",
                    },
                    ["timestamp"] = os.date("!%Y-%m-%dT%H:%M:%SZ"),
                }
            }
